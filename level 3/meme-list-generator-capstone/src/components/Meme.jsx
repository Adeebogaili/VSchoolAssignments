...
const memes = memesArray.map((meme, index) => {
    ...
    setMemesArray(prevMemesArray => prevMemesArray.filter((meme) => meme.id !== id ))
    }
    ...
    return (
        <main>
            ...
            <form className="form" onSubmit={handleSubmit} >
                ...
                <button className="submit-btn" type="submit">Submit <i className="fa-solid fa-paper-plane"></i></button>
            </form>
